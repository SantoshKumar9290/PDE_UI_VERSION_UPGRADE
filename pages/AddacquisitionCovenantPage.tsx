...
const AddacquisitionCovenantPage = () => {
    ...
    const CallToApplicationDetails = async (data: any) => {
        ...
        if (result.status) {
            ...
            let data = get(result, "data.covanants.acquireCovenents", [])
            let MyList = [];
        ...
        if (type == "delete") {
            ...
            if (CovenantDetails._id) {
                ...
                let covData = {
                    documentId: ApplicationDetails.applicationId,
                    covId: CovenantDetails._id,
                    covanants: { value: CovenantDetails.value ,type: "acquation"},
    ...
    return (
        <div className='PageSpacing'>
                ...
                <Row className='ApplicationNum mt-1'>
                    <Col lg={6} md={6} xs={12}>
                        <div className='ContainerColumn TitleColmn' onClick={() => { redirectToPage("/PartiesDetailsPage") }}>
                            <h4 className='TitleText left-title'>Details of Acquisition Property</h4>
                        </div>
                    </Col>
            ...
            {/* <pre>{JSON.stringify(CovenantList, null, 2)}</pre> */}
        </div>
    )
}

export default AddacquisitionCovenantPage;