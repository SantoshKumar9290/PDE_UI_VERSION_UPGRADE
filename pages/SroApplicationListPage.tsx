                            ...
                            <Row className='ApplicationNum'>
                                <Col lg={5} md={6} xs={6}>
                                    <div className='ContainerColumn' onClick={() => {redirectToPage("/ServicesPage")  }}>
                                        <h4 className='TitleText left-title'>{LoginDetails.sroOffice} Applications List<span>[అప్లికేషన్ల జాబితా]</span></h4>
                                    </div>
                                    {/* <h4 className='TitleText left-title'> {LoginDetails.sroOffice} Applications List<span>[అప్లికేషన్ల జాబితా]</span></h4> */}
                                </Col>
                                <Col lg={6} md={6} xs={6}>
...
export default SroApplicationListPage;